...
function SvgComponent(props) {
  ...
  return (
    <div className="d-flex">
      ...
      <div style={{ height: "10px", width: "10px" }}>{seatID}</div>
    </div>
  );
}
    ...
    <div>
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: "10px", paddingLeft:"30px" }}>{Bus.ArrivalTime}</p>
        </div>
      </div>
      {/* Seats */}
    </div>
...
function SeatInfo() {
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        <div style={{ width: "30px", height: "30px" }}>
          {<SvgComponent color={3}></SvgComponent>}
        </div>
  ...
  function bookSeat() {
    ...
    CitiesNode.once("value")
      ...
      .then((readCountTxn) => {
        ...
        console.log("userIndex", userIndex, "seats", seats);
